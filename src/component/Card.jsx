...
function Card({ product }) {
    ...
    return (
        <>
            <section>
                <div className='border border-zinc-100 group overflow-hidden shadow-md rounded-2xl hover:shadow-xl transition-all duration-300 cursor-pointer'>
                    <img className='rounded-t-2xl group-hover:scale-110 transition-all duration-300' src={product.image} alt={product.name} />
